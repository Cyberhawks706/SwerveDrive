...
public class RobotContainer {
    ...
    private final Joystick driverJoytick = new Joystick(2);

    public RobotContainer() {
        swerveSubsystem.setDefaultCommand(new SwerveJoystickCmd(
                swerveSubsystem,
                () -> -driverJoytick.getRawAxis(DriveConstants.kDriverYAxis),
                () -> driverJoytick.getRawAxis(DriveConstants.kDriverXAxis),
                () -> driverJoytick.getRawAxis(DriveConstants.kDriverRotAxis),
                () -> !driverJoytick.getRawButton(DriveConstants.kDriverFieldOrientedButtonIdx)));
