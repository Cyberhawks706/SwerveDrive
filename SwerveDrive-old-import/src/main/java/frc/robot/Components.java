...
public class Components {
    ...
    public static void init(){
        ...
        sparkLiftF = new BrushlessSparkWithPID(9, 0.0006, 0.00000001, 0.001, Constants.PID.Wheels.kFF, Constants.PID.Wheels.kIz, Constants.PID.Wheels.kMinOutput, Constants.PID.Wheels.kMaxOutput, 4000, Constants.PID.Wheels.minVel, Constants.PID.Wheels.maxAcc,Constants.PID.Wheels.allowedErr);
        ...
        sparkClawTilt = new BrushlessSparkWithPID(4, 0.0001, 0.000001, 0.0015, Constants.PID.Wheels.kFF, Constants.PID.Wheels.kIz, Constants.PID.Wheels.kMinOutput, Constants.PID.Wheels.kMaxOutput, Constants.PID.Wheels.maxVel, Constants.PID.Wheels.minVel, Constants.PID.Wheels.maxAcc, Constants.PID.Wheels.allowedErr);
